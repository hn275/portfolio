...
import { PROJECTS, ProjectCard } from "features/Project";
                    ...
                    >
                        <ProjectCard {...PROJECTS.collabify}>
                            <p className="text-main">
                                Collabify is an app for scheduling and event
                                planning. It lets users share their availability
                                and receive text notifications. Private groups
                                are available with password protection, and
                        ...
                        <ProjectCard {...PROJECTS.studySpaceFinder}>
                            <p>
                                This collaborative project helps students locate
                                available classrooms on campus (University of
                                Victoria.) I wrote the backend for this project,
                                and as we don&apos;t have direct access to UVic
                        ...
                        <ProjectCard {...PROJECTS.gradeTracker}>
                            <p>
                                Grade Tracker is a secure and user-friendly web
                                app for students to log and track their grades,
                                with a built-in authentication system.
                            </p>
                ...
                (with permission), open to all developers/students to use.
                    ...
                    >
                        ...
                        <section className="lg:grid grid-cols-[1fr,60%] place-items-center gap-5">
                            <SlideIn fromLeft>
                                <img
                                    className="max-h-80 hidden lg:block"
                                    src={Telus}
                                />
                            </SlideIn>
                    ...
                    <FadeIn>
                        ...
                        >
                            ...
                            <p>
                                You&apos;ve made it this far, might as
                                well&nbsp;
                                <AnimatedUnderline className="font-semibold">
                                    say hello
                                </AnimatedUnderline>
                                .
                                <br /> I would love to hear what you think
                                about&nbsp;
                                <a
                                    className="italic hover:underline"
                                    target="_blank"
                    ...
                    <footer className="p-4 text-slate-500 text-xs bg-secondary">
                        <div className="max-w-[1280px] mx-auto flex justify-between items-center">
                            <div className="flex gap-3">
                                <p>
                                    &copy; 2023 Hal Nguyen, all rights reserved.
                                </p>
                            </div>
                            <div>
                                SVGs by&nbsp;
