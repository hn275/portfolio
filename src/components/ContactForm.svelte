...
<style lang="postcss">
	...
	.toast > span {
		@apply w-max rounded-md p-3 font-semibold text-slate-950;
	}

	.toast {
		@apply fixed bottom-0 left-0 right-0 translate-y-full p-6 transition-all;
	}

	input,
	textarea {
		@apply border border-slate-900 bg-slate-900;
		@apply min-h-[3em] w-full rounded-md p-3;
