    ...
    return (
        <>
            ...
            >
                ...
                <p>
                    While I enjoy being an undergrad student in the department
                    of Computer Science at University of Victoria, my web
                    development skills are&nbsp;
                    <span className="italic">self-taught</span>, through
                    personal and collaborative projects, and through countless
                    debugging sessions.
                </p>
